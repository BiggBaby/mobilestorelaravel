					...
					<div class="col-sm-9">
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">Tìm thầy  {{count($sp_theoloai)}} sản phẩm</p>
								<div class="clearfix"></div>
							</div>
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-body">
											<p class="single-item-title" style="overflow: hidden; text-overflow: ellipsis; width: 250px; white-space: nowrap;">{{$sp->name}}</p>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									...
									<div class="single-item">
										...
										<div class="single-item-body">
											<p class="single-item-title" style="overflow: hidden; text-overflow: ellipsis; width: 250px; white-space: nowrap;">{{$sp_k->name}}</p>
											<p class="single-item-price" style="font-size: 15px">
												@if($sp_k->promotion_price!=0)
