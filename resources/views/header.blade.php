<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 101, Trần Phú, Hà Đông, Hà Nội</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 034 296 7751</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="index.html" id="logo"><img src="source/assets/dest/images/logo_main.jpg" width="200px" alt=""></a>
				</div>
								...
								<div class="cart-item">
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<span class="cart-item-amount">@if($product['item']['promotion_price']==0) {{number_format($product['item']['unit_price'])}}
